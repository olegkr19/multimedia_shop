...
<body>
  <div class="main_container">
            ...
            <div class="scrollbar_inner">
              <ul class="checkbox-filter">
                ...
                <li class="checkbox-item">
                  <a class="checkbox-link" href="{{$category->name}}/{{str_replace(' ','-',strtolower($brand->name))}}">
                      {{$brand->name}}
                  </a>
                </li>
                    @endforeach
    ...
    <br>
      ...
      <a class="btn btn-primary" href="{{url('/')}}" role="button" style="margin-bottom:10px;margin-left:250px;">@lang('products.go_back')</a>
</div>
</div>
<script>
